...
export const AdvancedStyleControls = ({ formData, onStyleChange, className = "" }) => {
  ...
  console.log("AdvancedStyleControls render - isExpanded:", isExpanded); // Debug log
  ...
  return (
    <div className={`advanced-style-controls ${className}`}>
      {/* Debug: Always visible to confirm component renders */}
      <div style={{ background: "yellow", padding: "5px", fontSize: "12px" }}>
        DEBUG: AdvancedStyleControls mounted | isExpanded: {String(isExpanded)}
      </div>
      ...
      <div className="controls-header">
        <button
          ...
          onClick={() => {
            console.log("Toggle clicked! Current isExpanded:", isExpanded); // Debug
            setIsExpanded(!isExpanded);
          }}
          aria-expanded={isExpanded}
          style={{ outline: "2px solid red" }} // Temporary debug styling
        >
